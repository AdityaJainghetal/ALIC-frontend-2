...
//   try {
//     const response = await axios.post('https://alic-backend-2.onrender.com/member/create', formData, {
...
//   try {
//     const response = await axios.get('https://alic-backend-2.onrender.com/member/display');
...
//     try {
//       await axios.delete(`https://alic-backend-2.onrender.com/member/${id}`)
//       return id
//     } catch (error) {
//       return rejectWithValue(error.response?.data || error.message)
//     }
