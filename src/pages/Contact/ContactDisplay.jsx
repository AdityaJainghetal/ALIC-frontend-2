...
const ContactDisplay = () => {
  ...
  const fetchEnquiries = async () => {
    try {
      const response = await fetch('https://alic-backend-2.onrender.com/contact/allcontact');
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await fetch(`https://alic-backend-2.onrender.com/contact/alldelete/${id}`, {
        method: 'DELETE',
      });
