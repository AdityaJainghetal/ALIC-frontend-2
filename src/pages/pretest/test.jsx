...
const CourseForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('https://alic-backend-2.onrender.com/test/create', data, {
        headers: {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white shadow rounded-lg p-6 sm:p-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-800">Create New Pre test</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="testmodule" className="block text-sm font-medium text-gray-700 mb-1">
                  Test type
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="Durations" className="block text-sm font-medium text-gray-700 mb-1">
                  Duration
                </label>
                <input
                  type="text"
